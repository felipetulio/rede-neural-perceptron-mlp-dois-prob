function [W1 W2 MatrizdeErros] = treino(taxaAprendizado, X, Yd, E )
...
while(abs(erroEpoca-erroEpocaAnterior) > E)
    ...
    for i = 1 : numPadroes
        ...
        %gradiente local da camada 1 (15 neuronios)
        derivadaCamada1 = DerivaSigmoide(Icamada1);
        gradLocalcamada1 = (gradLocalsaida(:,:)' * W2(:,2:16))' .* derivadaCamada1;
    ...
    MatrizdeErros(:,epoca+1) = erroEpoca ./ numPadroes;
    epoca = epoca + 1;   
end
